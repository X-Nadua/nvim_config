...
-- Basic UI elements
vim.cmd('highlight Normal guibg=#46021b guifg=#f66151')
vim.cmd('highlight NonText guibg=#46021b guifg=#46021b')
vim.cmd('highlight CursorLine guibg=#731738')
vim.cmd('highlight LineNr guifg=#c3343b')
vim.cmd('highlight CursorLineNr guifg=#f66151')
vim.cmd('highlight SignColumn guibg=#46021b')
vim.cmd('highlight StatusLine gui=bold guibg=#731738 guifg=#f66151')
vim.cmd('highlight StatusLineNC gui=bold guibg=#731738 guifg=#b53c45')
...
vim.cmd('highlight DiagnosticVirtualTextError guibg=#590218 guifg=#ff0000')
vim.cmd('highlight WarningMsg guifg=#ffcc00')
vim.cmd('highlight DiagnosticWarn guifg=#ffcc00')
vim.cmd('highlight DiagnosticVirtualTextWarn guibg=#591618 guifg=#ffcc00')
vim.cmd('highlight DiagnosticInfo guifg=#00ccff')
vim.cmd('highlight DiagnosticVirtualTextInfo guibg=#3f1632 guifg=#00ccff')
vim.cmd('highlight DiagnosticHint guifg=#00ffff')
vim.cmd('highlight DiagnosticVirtualTextHint guibg=#3f1b32 guifg=#00ffff')
